            ...
            <section className="lg:px-24 sm:px-7 px-5">
                <div className='container mx-auto'>
                    <div className="grid grid-cols-12 md:pt-20 pt-16 md:pb-14 pb-10 gap-6 lg:gap-10 items-center">
                        <InfoSection title='Verification Services' image="/assets/verification_services.webp"
                            leftClass='lg:order-1 order-0' description={`We bring our merchants a range of solutions suitable 
                                for all risk categories from traditional & low risk to emerging & high risk. We specialize in 
                                cutting edge high risk solutions even for international merchants.`}
                        />
                    </div>

                    <div className="grid grid-cols-12 gap-6 lg:gap-10 md:pb-14 pb-10">
                        <InfoSection title='Verification Services' image="/assets/verification_services_second.webp"
                            showBar={false} showAccordion={true}
                            showAccordionData={<Accordion items={VERIFICATION_ITEMS} isFirstOpen={true} />}
                        />
                    </div>
                </div>
            </section>
